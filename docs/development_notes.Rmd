...
<<<<<<< HEAD
The script `scrap_programs_tuiton_fees.R` takes the list of urls scraped previously and downloads the tuition fee and requirements data from the program pages. 
=======
The script `scrap_programs_tuition_fees.R` takes the list of urls scraped previously and downloads the tuition fee and requirements data from the program pages. 
>>>>>>> 1204547399cb447b4f59b54bde58899d60e84e4e
